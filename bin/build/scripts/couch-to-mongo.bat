...
set CLASSPATH=%APP_HOME%\lib\couch-to-mongo-0.0.2.jar;%APP_HOME%\lib\spring-boot-starter-2.4.2.jar;%APP_HOME%\lib\spring-boot-starter-logging-2.4.2.jar;%APP_HOME%\lib\org.ektorp-1.3.0.jar;%APP_HOME%\lib\mongodb-driver-sync-4.1.1.jar;%APP_HOME%\lib\json-20201115.jar;%APP_HOME%\lib\spring-boot-autoconfigure-2.4.2.jar;%APP_HOME%\lib\spring-boot-2.4.2.jar;%APP_HOME%\lib\jakarta.annotation-api-1.3.5.jar;%APP_HOME%\lib\spring-context-5.3.3.jar;%APP_HOME%\lib\spring-aop-5.3.3.jar;%APP_HOME%\lib\spring-beans-5.3.3.jar;%APP_HOME%\lib\spring-expression-5.3.3.jar;%APP_HOME%\lib\spring-core-5.3.3.jar;%APP_HOME%\lib\snakeyaml-1.27.jar;%APP_HOME%\lib\logback-classic-1.2.3.jar;%APP_HOME%\lib\log4j-to-slf4j-2.13.3.jar;%APP_HOME%\lib\jul-to-slf4j-1.7.30.jar;%APP_HOME%\lib\jackson-mapper-asl-1.9.7.jar;%APP_HOME%\lib\jackson-core-asl-1.9.7.jar;%APP_HOME%\lib\httpclient-cache-4.5.13.jar;%APP_HOME%\lib\httpclient-4.5.13.jar;%APP_HOME%\lib\commons-io-2.0.1.jar;%APP_HOME%\lib\slf4j-api-1.7.30.jar;%APP_HOME%\lib\mongodb-driver-core-4.1.1.jar;%APP_HOME%\lib\bson-4.1.1.jar;%APP_HOME%\lib\spring-jcl-5.3.3.jar;%APP_HOME%\lib\logback-core-1.2.3.jar;%APP_HOME%\lib\log4j-api-2.13.3.jar;%APP_HOME%\lib\httpcore-4.4.14.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\commons-codec-1.15.jar
